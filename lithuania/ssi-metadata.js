// ssi-metadata.js — Lithuania (#29, OECD #30) — Session 17
// Edition 01 · FIRST_REFRESH 2026-08-13

window.SSI_METADATA = {
  iso2: 'LT', iso3: 'LVA', folder: 'lithuania',
  name_en: 'Lithuania', name_local: 'Latvija',
  flag: '🇱🇹',
  country_number: 31, oecd_number: 30,
  edition: 'Edition 01', first_refresh: '2026-08-13', next_refresh: '2026-08-13',
  session: 'Session 17',
  TSO: 'Litgrid AB', regulator: 'VERT (Valstybinė energetikos reguliavimo taryba)',
  ...
  bbox: { lon_min: 20.95, lon_max: 26.84, lat_min: 53.90, lat_max: 56.45 },
  admin_levels: { L1: { count: 6, label: 'NUTS-3 region' }, L2: { count: 43, label: 'Novads' } },

  stats: { sources: 28, variables: 95, components: 6, modifiers: 6, substations: 505, regions: 10,
  ...
  R7_cyber: { ceiling: 1.05, desi_2024: 0.68, ceiling_note: 'no ceiling for LT (DESI 0.68)' },
  ...
  COMPONENTS: [
    { id: 'C', name: 'Continuity', weight: 0.20, color: '#941914', isNew: false,
      metrics: [
        { id: 'C1', name: 'SAIDI (planned + unplanned)',     intra: 0.30, global: 0.060, norm: 'P5/P95 inverse',  source: 'VERT 2024 — per-DSO' },
        { id: 'C2', name: 'SAIFI (interruption frequency)',   intra: 0.25, global: 0.050, norm: 'P5/P95 inverse',  source: 'VERT 2024 — per-DSO' },
        { id: 'C3', name: 'Voltage class (max kV)',           intra: 0.20, global: 0.040, norm: 'log-scaled',      source: 'OSM Overpass + AST' },
        { id: 'C4', name: 'Customer count (catchment)',       intra: 0.15, global: 0.030, norm: 'P5/P95 inverse',  source: 'ESO + STAT' },
        { id: 'C5', name: 'Restoration speed (CAIDI)',        intra: 0.10, global: 0.020, norm: 'P5/P95 inverse',  source: 'VERT 2024' },
      ]},
    { id: 'V', name: 'Voltage Quality', weight: 0.20, color: '#aa4234', isNew: false,
      metrics: [
        ...
        { id: 'V2', name: 'Tree-fall IRI',          intra: 0.15, global: 0.030, norm: 'forest-cover + wind',     source: 'Copernicus + LHMT-Klimats 2024', adaptive: true },
        { id: 'V3', name: 'Heat-wave IRI',          intra: 0.15, global: 0.030, norm: 'GDD anomaly',              source: 'Copernicus ERA5 + RIH', adaptive: true },
        { id: 'V4', name: 'Precipitation extremes', intra: 0.15, global: 0.030, norm: 'P95 of daily mm',         source: 'LHMT 2024' },
        { id: 'V5', name: 'Wind speed max',          intra: 0.15, global: 0.030, norm: 'P99 hourly m/s',           source: 'LHMT + ERA5' },
        { id: 'V6', name: 'Flood-zone overlay',     intra: 0.10, global: 0.020, norm: 'inactive for Lithuania',     source: 'LGT (R6c inactive)' },
        { id: 'V7', name: 'Coastal salt-spray',      intra: 0.10, global: 0.020, norm: 'distance-to-coast',         source: 'LGT + ISO 9223' },
      ]},
    { id: 'I', name: 'Infrastructure', weight: 0.20, color: '#b8863a', isNew: false,
      metrics: [
        ...
        { id: 'I2', name: 'Substation density',      intra: 0.20, global: 0.040, norm: 'per km²',  source: 'OSM + STAT' },
        { id: 'I3', name: 'Asset age cohort',         intra: 0.20, global: 0.040, norm: 'Markov-weighted', source: 'AST Annual Report' },
        { id: 'I4', name: 'Corrosion class ISO 9223', intra: 0.15, global: 0.030, norm: 'C1-C5 categorical', source: 'LGT + ISO 9223' },
        { id: 'I5', name: 'Thermal stress (R6 proxy)', intra: 0.15, global: 0.030, norm: 'corrosion-derived', source: 'IEEE C57.91' },
        { id: 'I6', name: 'Smart-meter penetration',  intra: 0.10, global: 0.020, norm: 'pct of customers',   source: 'ESO 2024 (99.9%)' },
      ]},
    { id: 'E', name: 'Economic', weight: 0.15, color: '#5d8563', isNew: false,
      metrics: [
        ...
        { id: 'E3', name: 'Unemployment rate',         intra: 0.15, global: 0.0225, norm: 'P5/P95',         source: 'STAT 2024' },
        { id: 'E4', name: 'R&D intensity (% GDP)',    intra: 0.15, global: 0.0225, norm: 'P5/P95 inverse', source: 'Eurostat NUTS-3 2024' },
        { id: 'E5', name: 'Elderly share (65+)',       intra: 0.15, global: 0.0225, norm: 'demographic',   source: 'STAT 2024' },
      ]},
    ...
    { id: 'T', name: 'Transition', weight: 0.15, color: '#22d3ee', isNew: true,
      metrics: [
        { id: 'T1', name: 'Transition stress score', intra: 0.25, global: 0.0375, norm: 'composite',         source: 'Ignitis Group phase-out 2024', isNew: true },
  ...
  VALIDATION_CHECKS: [
    ...
    { check: 'Polygon containment (615 subs → 10 NUTS-3 statistical regions)', criterion: 'Every sub falls inside exactly one geoBoundaries ADM1 polygon', status: 'verified', isNew: false },
  ...
  DATA_LAYERS: [
    { id: 'A', name: 'Continuity (C)',                vars: 12, status: 'LIVE', isNew: false, sources: 'ESO, VERT, AST' },
    { id: 'B', name: 'Voltage Quality (V)',            vars: 18, status: 'LIVE', isNew: false, sources: 'Copernicus ERA5, RIH, EFEHR, LGT' },
    { id: 'C', name: 'Infrastructure (I)',              vars: 15, status: 'LIVE', isNew: false, sources: 'OSM Overpass, AST, ISO 9223' },
    { id: 'D', name: 'Economic (E)',                     vars: 11, status: 'LIVE', isNew: false, sources: 'Eurostat NUTS-3, STAT, EU-SILC' },
    { id: 'E', name: 'Seismic (S)',                       vars:  8, status: 'LIVE', isNew: false, sources: 'EFEHR ESHM20' },
    { id: 'F', name: 'Transition (T)',                    vars: 14, status: 'NEW v4.0', isNew: true,  sources: 'Ignitis Group, Litgrid RES, Nord Pool, VVD (Valsts vides dienests)' },
    { id: 'G', name: 'R3 economic tier',                  vars:  6, status: 'LIVE', isNew: false, sources: 'Eurostat + STAT' },
  ...
  DATA_SOURCES: [
    { name: 'Litgrid AB',                            category: 'TSO',         freq: 'Annual + 15-min', res: 'TSO-wide',  vars: 18, feeds: 'R2, R4, F1, T1',            registration: '' },
    { name: 'VERT',                       category: 'Regulator',   freq: 'Annual',          res: 'Per-DSO',   vars: 12, feeds: 'R2, R4 (quality + tariff)', registration: '' },
    { name: 'ESO AS',                        category: 'DSO',         freq: 'Annual',          res: 'NUTS-3 region',   vars: 15, feeds: 'R2, R4, T1',                 registration: '' },
    { name: 'STAT (Lietuvos statistikos departamentas)',    category: 'Stats',       freq: 'Annual + Q',      res: 'NUTS-3',    vars: 22, feeds: 'R3, E2, P',                 registration: '' },
    { name: 'Lietuvos bankas',                             category: 'Central bank',freq: 'Annual',          res: 'National',  vars:  8, feeds: 'R3 macro',                   registration: '' },
    { name: 'LHMT (RIH)',              category: 'Met service', freq: 'Daily + 30y',     res: 'Stations',  vars: 14, feeds: 'I1-I3, R5',                  registration: '' },
    { name: 'LGT (Latvijas Ģeotelpiskās informācijas aģentūra)',         category: 'GIS',         freq: 'Biennial',        res: 'NUTS-3 region',   vars:  6, feeds: 'R6c (inactive for EE)',      registration: '' },
    { name: 'LHMT (LHMT-Klimats)',               category: 'Climate',     freq: 'Biennial',        res: 'National',  vars:  5, feeds: 'R2 climate trajectory',      registration: '' },
    ...
    { name: 'EU Just Transition Fund',                  category: 'Policy',      freq: 'Multi-yr',        res: 'Utena',  vars:  4, feeds: 'T transition narrative',     registration: '' },
    { name: 'CEER Benchmarking 2024',                   category: 'Peer',        freq: 'Annual',          res: 'National',  vars:  5, feeds: 'SAIDI peer comparison',      registration: '' },
    { name: 'RTU',                                    category: 'R&D',         freq: 'Annual',          res: 'Vilnius',      vars:  2, feeds: 'T innovation',               registration: '' },
  ...
  FREQ_DISTRIBUTION: {
    ...
    Quarterly: { sources: ['DESI','LGT','Ignitis Group transition'], count: 3 },
    Annual: { sources: ['AST','VERT','ESO','STAT','Lietuvos bankas','LHMT-Klimats','VVD (Valsts vides dienests)','EFEHR'], count: 8 },
  },

  // ── CHANGELOG (each with id + change + type) ──
  CHANGELOG: [
    { id: 'LT-S17--9', change: 'Hotfix #3 — R3 Light/Rural tier distinct (1.08, was collapsing to Commercial 1.06)',  type: 'new' },
    { id: 'LT-S17--8', change: 'Hotfix #2 — substation socio_economic (GDP/cap, R&D, unemployment) + regions median_R alias', type: 'data' },
    { id: 'LT-S17--7', change: 'Hotfix #1 — grid-geo.json to FR-compatible schema + landing path active (red)',         type: 'new' },
    { id: 'LT-S17--6', change: 'Wave D — 5-commit deploy to ikengassiindex.github.io/lithuania/',                          type: 'new' },
    { id: 'LT-S17--5', change: 'Wave C — 8 HTML pages + ssi-metadata.js + grid-geo.json + bounds.json (geoBoundaries ADM1)', type: 'new' },
    { id: 'LT-S17--4', change: 'Wave B — scoring-ee engine: Markov (medium tier) + MC + Sobol + 614-sub R-distribution', type: 'new' },
    { id: 'LT-S17--3', change: 'Wave A — digital-twin-ee + 12 modules incl. d08_nordpool + d09_brell_legacy (NEW shared)', type: 'data' },
    { id: 'LT-S17--2', change: 'd05_osm LIVE — 5,037 raw → 614 substantive via KB §38 small-country filter (10.0% retention)', type: 'data' },
    { id: 'LT-S17--1', change: 'KB v12 → v13 + BPG v1.11 → v1.12 — Part XIV Baltic Onboarding Roadmap',                  type: 'enhanced' },
  ],
};
