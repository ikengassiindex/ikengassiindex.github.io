...
window.SSI_METADATA.DATA_SOURCES = [
  ...
  { id: 'd07_copernicus',    name: 'Copernicus ERA5 + CMIP6 + UNGRD',                                                                        freq: 'Monthly',    status: 'live', vars: 5,  feeds: 'R6_climate', sources: 'cds.climate.copernicus.eu SSP2-4.5 · Andean elevation + Pacific-Caribbean tropical reanalysis + ENSO indices · UNGRD (Unidad Nacional para la Gestión del Riesgo de Desastres) emergency coordination (1985 Armero ex-post + 2017 Mocoa + 2024 La Niña floods)' },
