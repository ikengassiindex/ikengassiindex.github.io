...
window.SSI_METADATA.COMPONENTS = [
  ...
  { id: 'I', name: 'Infrastructure', weight: 0.25, color: '#5d8563', isNew: false,
    metrics: [
      ...
      { id: 'I6', name: 'Substation density',               intra: 0.10, global: 0.025, norm: 'per km²',              source: 'OSM + INEC (~170-300 subs across 51,100 km²)' },
...
window.SSI_METADATA.VALIDATION_CHECKS = [
  ...
  { check: 'MIN_FLEET[CR] floor enforced',                            criterion: 'Actual fleet ≥ 170 substations exceeds MIN_FLEET[CR]=150 — stub-gate clear',         status: 'verified', isNew: true },
