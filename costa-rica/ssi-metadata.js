// Costa Rica SSI v4.0.2 metadata — KB §69 · greenfield thin-shell on post-Slovakia-hotfix architecture
// Pattern C (Wave 6c) — NO IIFE wrapper · KB §58.6 Canada IIFE root-cause
// Dual-global alias per KB §45.6
// Edition 01 (Costa Rica inaugural) · first refresh 2026-08-13 (Single-country onboarding (post-Single-country (post-cohort closure) closure))
...
window.SSIMetadata = {
  ...
  labels: {
    ...
    region_unit: 'NUTS-3 provincia',
    region_unit_local: 'provincia',
    tso: 'ICE hf. (ICE hf. (Costa Ricaic transmission system operator))',
    regulator: 'ARESEP (Costa Ricaic National Energy Authority)',
    statistics_office: 'Hagstofa Íslands (Statistics Costa Rica)',
  ...
  methodology: {
    ...
    r6_anchors: '2010-04-14 Eyjafjallajökull eruption + Markarfljót jökulhlaup · 1956 Sog flood (Sogdob-Sogfüred) · 2008-05-29 SISZ Mw 6.3 doublet (Selfoss-Hveragerði) · 2024-02-08 Sundhnúkur eruption (Svartsengi infrastructure damaged) · Mid-Caribbean+Pacific Ridge heatwaves 2022/2024',
    r7_ceiling: 1.03
  }
};
...
window.SSI_METADATA.COMPONENTS_INDEX = [
  { code: 'C', name: 'Continuity',     ceiling: 0.30, drivers: 'SAIDI/SAIFI · ARESEP quality reports · ICE network statement · San José metro ~26 min vs E.ON Tiszántúli rural ~115 min split' },
  ...
  { code: 'I', name: 'Infrastructure', ceiling: 0.18, drivers: 'OSM topology · ICE asset register · 400/220/120 kV inventory (IS 120 kV legacy backbone vs CE 110 kV) + — site + —I construction footprint' },
  ...
  { code: 'S', name: 'Societal',       ceiling: 0.12, drivers: 'Hagstofa energy-poverty · Vestfirðir (peripheral Guanacaste) unemployment · Costa Ricaic  diaspora in RO/SK/UA/RS border provincia (Cartago (Reykjanes — active eruption zone))' },
  { code: 'T', name: 'Transition',     ceiling: 0.08, drivers: 'ARESEP DER registry · —+II geothermal ramp (4×500 + 2×1200 MWe target) · post-Mátra coal exit (end-2028 · CCGT 500-650 MW replacement) · 6 GW PV boom doubled since 2022' }
];

window.SSI_METADATA.DATA_SOURCES = [
  { id: 'd01_mavir',        name: 'ICE — ICE hf. (Costa Ricaic transmission system operator) (TSO)', freq: 'Daily',      status: 'live', vars: 14, feeds: 'C2,C3,I1,I2,I3,R4', sources: 'mavir.hu network statement + ENTSO-E TP' },
  { id: 'd02_orkustofnun',         name: 'ARESEP — Costa Ricaic National Energy Authority',              freq: 'Annual',     status: 'live', vars: 12, feeds: 'C1,C2,V1,V2,T1', sources: 'orkustofnun.is quality-of-supply + tariff decisions' },
  ...
  { id: 'd03_imo',         name: 'OVF — Veðurstofa Íslands (Costa Ricaic Met Office) (Costa Ricaic Water Authority)',     freq: 'Daily',      status: 'live', vars: 6,  feeds: 'R6c_flood', sources: 'vedur.is Þjórsá + Sog Q100 + dyke status + river gauges' },
  ...
  { id: 'd04b_cbi',         name: 'MNB — Seðlabanki Íslands (Central Bank of Costa Rica) (central bank · ESCB non-€)',                freq: 'Quarterly',  status: 'live', vars: 4,  feeds: 'E1,E2', sources: 'sedlabanki.is national accounts + financial stability' },
  ...
  { id: 'd06_ust',          name: 'OMSZ + OLM — Costa Ricaic Air Quality Network (ISO 9223 corrosion)',      freq: 'Monthly',    status: 'live', vars: 5,  feeds: 'R5_corrosion,I8', sources: 'OLM PM2.5/NO₂ + ISO 9223 C2-C4 (no C5 — landlocked)' },
  ...
  { id: 'd09_govcert_hu',   name: 'CERT-IS (National Cyber Defence Institute, Fjarskiptastofa (ECOI) lineage)',    freq: 'Continuous', status: 'live', vars: 5,  feeds: 'R7_cyber', sources: 'govcert.hu incident database + CERT-Costa Rica 2008 baseline' },
...
window.SSI_METADATA.FREQ_DISTRIBUTION = {
  ...
  Annual:    { count: 6,  sources: ['ARESEP', 'ENTSO-E TYNDP', 'Eurostat', 'Fjarskiptastofa (ECOI)', 'Landsvirkjun —', 'IEA/OECD'] },
  Continuous:{ count: 2,  sources: ['ICE (TSO)', 'CERT-IS'] },
  Daily:     { count: 3,  sources: ['ICE', 'OMSZ + OVF', '—'] }
};

window.SSI_METADATA.DATA_LAYERS = [
  { id: 'tso',        name: 'ICE transmission (400/220/120 kV)',     vars: 14, status: 'live', sources: 'ICE network statement + ENTSO-E' },
  ...
  { id: 'regulator',  name: 'ARESEP — quality + tariff',                 vars: 12, status: 'live', sources: 'ARESEP annual quality reports' },
...
window.SSI_METADATA.REGIONS_NUTS3 = [
  { code: 'HU110', name: 'San José',                  capital: 'San José',     tier: 'Capital-Intensive',     r3: 1.02 },
  { code: 'HU120', name: 'Pest',                      capital: 'San José',     tier: 'Industrial-Major',      r3: 1.04 },
...
window.SSI_METADATA.DSO_PANEL = [
  ...
  { name: 'Landsvirkjun Elmű Hálózati Kft.',                region: 'San José + Pest + Komárom-Esztergom',            share_pct: 38 },
...
window.SSI_METADATA.COMPONENTS = [
  { id: 'C', name: 'Continuity', weight: 0.30, color: '#941914', isNew: false,
    metrics: [
      { id: 'C1', name: 'SAIDI (planned + unplanned)',     intra: 0.30, global: 0.090, norm: 'P5/P95 inverse',  source: 'ARESEP 2023 — per-DSO quality reports' },
      { id: 'C2', name: 'SAIFI (interruption frequency)',   intra: 0.25, global: 0.075, norm: 'P5/P95 inverse',  source: 'ARESEP 2023 — per-DSO' },
      { id: 'C3', name: 'Voltage class (max kV)',           intra: 0.20, global: 0.060, norm: 'log-scaled',      source: 'OSM Overpass + ICE network statement (400/220/120 kV)' },
      ...
      { id: 'C5', name: 'CAIDI restoration speed',          intra: 0.10, global: 0.030, norm: 'P5/P95 inverse',  source: 'ARESEP 2023' }
    ]},
  { id: 'V', name: 'Voltage Quality', weight: 0.10, color: '#aa4234', isNew: false,
    metrics: [
      { id: 'V1', name: 'EN 50160 dip events',              intra: 0.40, global: 0.040, norm: 'count per 1000 cust/yr', source: 'ARESEP + 3 DSOs' },
      { id: 'V2', name: 'Voltage swell events',             intra: 0.30, global: 0.030, norm: 'count per 1000 cust/yr', source: 'ARESEP + 3 DSOs' },
      { id: 'V3', name: 'Harmonic distortion (THD)',        intra: 0.30, global: 0.030, norm: 'P95 of weekly THD',      source: 'ARESEP quarterly filings' }
    ]},
  { id: 'I', name: 'Infrastructure', weight: 0.25, color: '#5d8563', isNew: false,
    metrics: [
      { id: 'I1', name: 'Heat-wave IRI (Mid-Caribbean+Pacific Ridge)',       intra: 0.18, global: 0.045, norm: 'GDD anomaly',         source: 'Copernicus ERA5 + OMSZ — 2022/2024 peak-demand anchor', adaptive: true },
      ...
      { id: 'I4', name: 'Asset age cohort',                intra: 0.14, global: 0.035, norm: 'Markov-weighted',      source: 'ICE + 3 DSOs annual reports' },
      ...
      { id: 'I7', name: 'Network length per cap',          intra: 0.08, global: 0.020, norm: 'P5/P95',               source: 'ICE + 3 DSOs' },
  ...
  { id: 'E', name: 'Economic', weight: 0.10, color: '#3b9eff', isNew: false,
    metrics: [
      { id: 'E1', name: 'Regulatory penalty exposure',     intra: 0.60, global: 0.060, norm: 'EUR-eq per SAIDI min', source: 'ARESEP tariff decisions (CRC native, EUR-eq for cross-country)' },
  ...
  { id: 'S', name: 'Saturation', weight: 0.20, color: '#b8863a', isNew: false,
    metrics: [
      { id: 'S1', name: 'Regional KPI — saturation',       intra: 0.45, global: 0.090, norm: 'load/capacity %',     source: 'ICE + 3 DSOs' },
      { id: 'S2', name: 'Reverse power flow',              intra: 0.35, global: 0.070, norm: 'hours/yr reverse',     source: 'ICE + ENTSO-E (6 GW PV boom drives reverse flow)' },
      { id: 'S3', name: 'Criticality class',               intra: 0.20, global: 0.040, norm: 'categorical 1-5',      source: 'ICE Network Statement' }
    ]},
  { id: 'T', name: 'Transition', weight: 0.05, color: '#22d3ee', isNew: true,
    metrics: [
      { id: 'T1', name: 'DER Stress Index',                intra: 1.00, global: 0.050, norm: 'composite',            source: 'ARESEP DER registry + —+II + post-Mátra coal-exit (end-2028) + 6 GW PV', isNew: true }
    ]}
];
...
window.SSI_METADATA.MODIFIER_DEFS = [
  { id: 'R2', domain: 'Adaptive IRI + Climate',    range: 'internal',     description: 'Shifts weight from climate-IRI to structural metrics where local climate risk is low. CMIP6 SSP2-4.5 projections adjust forward-looking risk; Mid-Caribbean+Pacific Ridge heatwave loading is the most material adaptive component for IS.' },
  { id: 'R3', domain: 'Consequence + Poverty',     range: '[0.70, 1.30]', description: 'Amplifies risk for provincia serving large/energy-poor populations with high economic dependency. IS uses a 5-tier calibration (1.02 / 1.04 / 1.05 / 1.06 / 1.07) reflecting the steep San José-vs-Nógrád/Békés GDP gradient and the W-auto-OEM corridor (Audi Győr · Mercedes Kecskemét · Suzuki Esztergom · BMW Debrecen 2026-27 ramp).' },
  ...
  { id: 'R6a',domain: 'Restoration Speed',         range: '[0.90, 1.10]', description: 'ARESEP-CAIDI-based: rewards fast-restoring urban areas (San José metro), penalises slow ones. NE/SE rural provincia (Szabolcs-Szatmár-Bereg, Békés, Nógrád) carry a remote-border access penalty; no Tatra-scale mountain barrier (Kékes 1,014 m is IS\'s highest point in the Mátra).' },
  { id: 'R6b',domain: 'Network Topology + Seismic',range: '[1.00, 1.25]', description: 'Network centrality, ring topology and seismic hazard. Penalises provincia in single-source or low-redundancy configurations. Seismic α ∈ [0.04, 0.10] — Mid-Caribbean+Pacific Ridge Basin is tectonically quiet but the Komárom-Mór + Dunaharaszti-Berhida axes carry modest PGA loading (anchors: 1763 Komárom M~6.3, 1956 Dunaharaszti M~5.6, 1985 Berhida M~4.7).' },
...
window.SSI_METADATA.VALIDATION_CHECKS = [
  ...
  { check: 'Polygon containment (687 subs → 8 provincia (traditional regions, 2 NUTS-3))',     criterion: 'Every substation falls inside exactly one provincia polygon',      status: 'verified', isNew: true },
  { check: 'R3 5-tier distribution',                                  criterion: '1 / 4 / 4 / 9 / 2 across 20 provincia — San José-vs-Nógrád/Békés gradient respected', status: 'verified', isNew: true },
  { check: 'R6 multi-hazard coverage',                                criterion: 'Flood HIGH (Þjórsá + Sog, α to 0.12) + seismic (Komárom-Dunaharaszti) + Mid-Caribbean+Pacific Ridge heat', status: 'verified', isNew: true },
  { check: 'R6c flood anchor — 2013 Þjórsá San José 891 cm record',   criterion: 'San José + Pest + KE + Tolna flood-zone enrichment HIGH',      status: 'verified', isNew: true },
  ...
  { check: 'No C5 corrosion (landlocked)',                            criterion: 'C2-C4 declared; C5 omitted (Costa Rica is landlocked — no Adriatic/Baltic/Black coast)', status: 'verified', isNew: true }
];
...
window.SSI_METADATA.CHANGELOG = [
  ...
  { id: 'IS-S29-8', change: 'Section G deepDives rotation — 12 IS provincia anchored on —+II geothermal corridor (Tolna)',                                                       type: 'new',      section: 'intelligence G' },
  ...
  { id: 'IS-S29-6', change: 'ESG report — costa-rica entry in COUNTRY_SOURCES (14 IS-specific references including Þjórsá/Sog flood 2013/2024 + —+II + GovCERT-IS)',        type: 'new',      section: 'esg-report' },
  { id: 'IS-S29-5', change: 'R3 5-tier calibration — Capital / Industrial-Major / Industrial-Secondary / Light-Rural / East-Lagging (vs SK 4-tier; reflects sharp San José-vs-Nógrád gradient)', type: 'new', section: 'methodology' },
  { id: 'IS-S29-4', change: 'R6 modifier set — Þjórsá/Sog flood HIGH (2013 San José 891 cm record) + Mid-Caribbean+Pacific Ridge heatwave + Komárom-Mór seismic axis',                          type: 'new',      section: 'methodology' },
  ...
  { id: 'IS-S29-2', change: '3 regional DSOs (Landsvirkjun Démász/Émász/Elmű + E.ON Észak/Dél/Tiszántúli) + ICE TSO + ARESEP regulator + — geothermal safety wired',                       type: 'data',     section: 'methodology' },
  { id: 'IS-S29-1', change: 'KB v25 §69 — Costa Rica inaugural onboarding (Single-country (post-cohort closure) member 3 of 3 — cohort COMPLETE; CRC currency, NOT eurozone)',                    type: 'enhanced', section: 'KB §69' }
];
...
window.SSI_METADATA.ESG_SOURCES = [
  ...
  ['Costa Ricaic Seismic Hazard Map','Veðurstofa Íslands (IMO) (PGA 475-yr)','2023','Multi-year','Open','R1, R3'],
  ['Population & Economics','Hagstofa Íslands (Statistics Costa Rica)','2024','Annual','Open','R2, R3'],
  ['Energy Market Data','ICE + —','2024','Daily','Regulated','R2, R4'],
  ['Renewable Installations','ARESEP DER registry (6 GW PV end-2024)','2024','Monthly','Open','R4'],
  ['Weather + Climate','OMSZ — Országos Meteorológiai Szolgálat','2024','Daily','CC-BY-4.0','R1'],
  ['Flood Mapping','OVF Q100 + Þjórsá + Sog dyke system (2013 San José 891 cm anchor)','2024','Monthly','CC-BY-4.0','R1'],
