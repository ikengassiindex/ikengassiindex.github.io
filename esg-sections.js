...
(function () {
  ...
  var ITALY_FALLBACK_SOURCES = [
    ...
    ['GADM Administrative Areas 4.1 (Colombia)', 'UC Davis geodata.ucdavis.edu/gadm', '2022', 'Multi-year', 'CC BY (academic derivative)', 'R2'],
