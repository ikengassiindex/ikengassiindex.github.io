...
window.SSI_METADATA.DATA_SOURCES = [
    { id:"StatCan", name:"Statistics Canada (StatCan)", freq:"Quarterly", res:"Provincial", vars:4, category:"Socio-Econ", feeds:"E1-E2, I1 — GDP, unemployment, population, CPI" },
    { id:"CER", name:"Canada Energy Regulator (CER)", freq:"Annual", res:"Utility", vars:3, category:"Regulatory", feeds:"C1-C4, V1-V2, I1 — outage reports, asset filings" },
    { id:"NRCan", name:"Natural Resources Canada (NRCan)", freq:"Annual", res:"National", vars:3, category:"Geoscience", feeds:"I2, I3 — seismic hazard, flood maps, energy stats" },
    { id:"EC", name:"Environment and Climate Change Canada (ECCC)", freq:"Daily", res:"Station", vars:4, category:"Weather", feeds:"I2, R6b — temperature, wind speed, humidity, precipitation" },
    { id:"HQ", name:"Hydro-Québec (HQ)", freq:"Monthly", res:"Substation", vars:4, category:"Grid", feeds:"C1-C4, V1, S1 — SAIDI, SAIFI, load, DER capacity" },
    { id:"IESO", name:"Ontario IESO (Independent Electricity System Operator)", freq:"Hourly", res:"Zone", vars:4, category:"Grid", feeds:"C1, S1-S2, E1 — real-time demand, generation mix, capacity" },
    { id:"BCH", name:"BC Hydro", freq:"Monthly", res:"Region", vars:4, category:"Grid", feeds:"C1-C4, V1, S1 — SAIDI, SAIFI, capacity, renewables" },
    { id:"AESO", name:"Alberta Electric System Operator (AESO)", freq:"Monthly", res:"Zone", vars:4, category:"Grid", feeds:"S1-S2, T1 — demand, generation, wind MW, solar MW" },
    { id:"SKP", name:"SaskPower", freq:"Annual", res:"Region", vars:3, category:"Grid", feeds:"C1, T1 — SAIDI, load, generation mix" },
    { id:"MH", name:"Manitoba Hydro", freq:"Annual", res:"Region", vars:3, category:"Grid", feeds:"C1 — SAIDI, SAIFI, hydro generation" },
    { id:"NBP", name:"NB Power (New Brunswick)", freq:"Annual", res:"Region", vars:3, category:"Grid", feeds:"C1, T1 — reliability, nuclear, wind" },
    { id:"NSP", name:"Nova Scotia Power", freq:"Annual", res:"Region", vars:3, category:"Grid", feeds:"C1, T1 — SAIDI, SAIFI, coal phase-out" },
    { id:"NERC", name:"NERC (North American Electric Reliability Corporation)", freq:"Annual", res:"Regional", vars:3, category:"Regulatory", feeds:"I1, I2 — reliability standards, compliance, N-1 status" },
    { id:"IEA", name:"IEA Global EV Data Explorer", freq:"Annual", res:"National", vars:3, category:"Transition", feeds:"T1, S1 — EV stock, EV share, charging infrastructure" },
    { id:"OSM", name:"OpenStreetMap — Power Infrastructure", freq:"Continuous", res:"Node", vars:3, category:"Grid", feeds:"I2, R4 — substation location, line routing, land use" },
    { id:"NRCan-S", name:"NRCan Seismic Hazard Calculator", freq:"Real-time", res:"Point", vars:3, category:"Hazard", feeds:"R6b — PGA, spectral acceleration, soil class" },
