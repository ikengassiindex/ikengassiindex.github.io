...
window.SSIMetadata = (function () {
  ...
  first_refresh: "2026-04",
  session_1_date: "2026-04",
  edition: "001",
  ...
  DATA_SOURCES: [
    ...
    { id:"OSM",         name:"OpenStreetMap — Power Infrastructure (augmented by Nukissiorfiit grid map)", url:"overpass-api.de", freq:"Monthly", res:"Node", vars:6, category:"Infrastructure", feeds:"I4 (graph degree within each islanded system), 36 substations + 74 plants + 125 lines mapped across 4 active Kommuner (Avannaata OSM coverage pending), no inter-settlement HV links" },
    ...
    { id: "StatGreenland", name: "Statistics Greenland National Accounts + LFS", url: "stat.gl", freq: "Annual", res: "5 kommuner", vars: 5, category: "Socio-Econ", feeds: "R2 per-kommune GDP/cap, unemp, elderly%" },
  ],
  ...
  PIPELINE: [
    ...
    { step:2, name:"Normalise", desc:"Four normalisation methods: Method A (fleet percentile P5/P95), Method B (inverse percentile), Method C (binary compliance), Method D (categorical). Small-N guardrail relaxes R3 tier-balance to 2–50% per tier given N=37 (Edition 001 scored fleet).", icon:"📐" },
    ...
    { step:6, name:"Monte Carlo", desc:"Edition 001: 1,000 iterations per substation (37,000 total draws) with independent component perturbation — Gaussian copula held off at N=37 (§8.2). Canonical 10,000 iter + 20×20 copula resumes once fleet size stabilises. Captures measurement, spatial, staleness, and model uncertainty.", icon:"🎲" },
  ...
  methodology_sections: [
      ...
      { id:"m8", title:"Small-N Guardrail",      body:"With N=37 at Edition 001 (36 OSM substations + 1 Avannaata transformer, Ilulissat node/11958572184), Greenland is by some margin the smallest fleet in the SSI catalogue. The standard R3 tier-balance guardrail (5–45% per tier) is relaxed to 2–50% per tier for small-N countries (N<500). Monte Carlo is held at 1,000 iterations per substation (37,000 total draws) with independent component perturbation — Gaussian copula remains held off until the correlation matrix can be calibrated on a stable fleet. Distribution, percentile and Monte-Carlo stability are reported with wider CI bands until N crosses the 50-station floor." }
  ],
  ...
  CHANGELOG: [
    { id:"GL1",  change:"Greenland country launch — 37 substations (36 OSM + 1 Avannaata transformer, Ilulissat) + 74 plants + 125 lines across 5 Kommuner. Session 1 scored 2026-04-16 with Arctic/Greenland-calibrated inputs (Stat.gl + Nukissiorfiit + Asiaq/DMI + GEUS). ~70 islanded micro-grids.", type:"new" },
    ...
    { id:"GL13", change:"R3 small-N relaxation — tier balance 2–50% per tier (vs standard 5–45%) given N=37 at Edition 001 (36 OSM + 1 Avannaata transformer)",             type:"enhanced" },
    ...
    { id:"GL18", change:"FIRST_REFRESH brought forward from 2026-07 → 2026-04 — Session 1 scored early on OSM bootstrap + Arctic public-data calibration",                 type:"ops" },
    { id:"GL19", change:"Avannaata substation added (GL_0037) — Ilulissat transformer node/11958572184 from OSM Overpass (power=transformer, Gamle elværk)",                type:"data" },
    { id:"GL20", change:"Edition 001 scored — 37 substations, MC 1000/sub (§8 Small-N Guardrail active), fleet R_median 0.779, 78% Critical band reflecting isolated-grid fragility vs Nordic peers (Denmark R_med ~0.24)",                type:"release" }
  ],

  /* ── version tracking ── */
  version: {
      ssi_version: "v4.0.2",
      country_deployment_version: "1.1",
      first_deployed: "2026-04-16",
      first_refresh: "2026-04",
      session_1_date: "2026-04-16",
      edition: "001",
      last_scoring_run: "2026-04-16",
      last_schema_validation: "2026-04-16"
    }
