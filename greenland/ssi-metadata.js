...
window.SSIMetadata = (function () {
  ...
  PIPELINE: [
    ...
    { step:2, name:"Normalise", desc:"Four normalisation methods: Method A (fleet percentile P5/P95), Method B (inverse percentile), Method C (binary compliance), Method D (categorical). Small-N guardrail relaxes R3 tier-balance to 2–50% per tier given N=36 (bootstrap fleet, projected ~250 at Session 1).", icon:"📐" },
  ...
  methodology_sections: [
      ...
      { id:"m8", title:"Small-N Guardrail",      body:"With N=36 at bootstrap (projected ~250 at Session 1 once the Nukissiorfiit asset register supplements OSM coverage), Greenland is by some margin the smallest fleet in the SSI catalogue. The standard R3 tier-balance guardrail (5–45% per tier) is relaxed to 2–50% per tier for small-N countries (N<500). This preserves the rule as default while accommodating legitimately small fleets without manual overrides. Distribution, percentile and Monte-Carlo stability are reported with wider CI bands until N crosses the 50-station floor." }
  ],
  ...
  CHANGELOG: [
    { id:"GL1",  change:"Greenland country launch — 36 substations + 74 plants + 125 lines across 4 active Kommuner (bootstrap from OSM 2026-04-16; projected ~250 substations at Session 1 2026-07 once Nukissiorfiit asset register is integrated). ~70 islanded micro-grids.", type:"new" },
    ...
    { id:"GL13", change:"R3 small-N relaxation — tier balance 2–50% per tier (vs standard 5–45%) given N=36 bootstrap (projected ~250 at Session 1)",                     type:"enhanced" },
