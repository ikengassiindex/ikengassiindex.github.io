...
window.SSI_METADATA = {
  ...
  admin_levels: { L1: { count: 15, label: 'NUTS-3 region' }, L2: { count: 79, label: 'Omavalitsus' } },

  stats: { sources: 28, variables: 95, components: 6, modifiers: 6, substations: 614, NUTS-3 region: 15,
  ...
  DATA_SOURCES: [
    ...
    { name: 'NordBalt LV-SE HVDC',                                category: 'Cross-bd',    freq: 'Hourly',          res: 'EE-FI',     vars:  4, feeds: 'R4 cross-border',            registration: '' },
  ...
  CHANGELOG: [
    ...
    { id: 'EE-S15-6', change: 'Wave D — 5-commit deploy to ikengassiindex.github.io/latvia/',                          type: 'new' },
    ...
    { id: 'EE-S15-2', change: 'd05_osm LIVE — 5,831 raw → 614 substantive via KB §38 small-country filter (20.9% retention)', type: 'data' },
