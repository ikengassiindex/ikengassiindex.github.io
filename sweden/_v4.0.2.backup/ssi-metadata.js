...
window.SSIMetadata = (function () {
  ...
  DATA_SOURCES: [
    ...
    { id:"DISTRIBUTOR", name:"Distribution Companies (E.ON, Vattenfall, Ellevio, Göteborg Energi)", url:"", freq:"Annual", res:"Distribution Company", vars:4, category:"Grid", feeds:"S1 variant (thermal plant load), CAPEX, SAIDI/SAIFI, transformer inventories" },
