"""
SSI Pipeline — Austria v4.23 ingestion, shared base layer.
...
def emit_audit_sidecar(
    ...
    *,
    ...
    parent_preflight_yaml: str = "austria/v4_23-ingestion-audit-austria-preflight.yaml",
) -> Path:
    ...
    out_path = output_dir / f"v4_23-ingestion-audit-austria-{slug}.yaml"

    lines = [
        "# SSI Index v4.23 workstream — Austria ingestion fetch audit",
