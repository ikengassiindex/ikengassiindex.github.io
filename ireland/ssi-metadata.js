...
window.SSIMetadata = (function () {
  ...
  const DATA_SOURCES = [
    { id: 'CRU',    name: 'CRU (Commission for Regulation of Utilities)',  url: 'cru.ie',                                 freq: 'Annual',    res: 'County',     vars: 8,  category: 'Grid',          feeds: 'C1–C4 (SAIDI/SAIFI), I1–I3 (IRI), quality regulation' },
    { id: 'ODRE',   name: 'ESBN Open Data (ESB Networks)',         url: 'esbnetworks.ie/open-data',                 freq: 'Quarterly', res: 'County',          vars: 5,  category: 'Transition',    feeds: 'T1 DER capacity, solar/wind registry' },
    { id: 'CSO',  name: 'CSO (Central Statistics Office)',   url: 'cso.ie',                              freq: 'Annual',    res: 'County',     vars: 8,  category: 'Socio-Econ',    feeds: 'R3 population, elderly, GDP, fiscal capacity' },
    ...
    { id: 'JRC',    name: 'JRC DSO Observatory',                           url: 'ses.jrc.ec.europa.eu',                  freq: 'Annual',    res: 'DSO-level',       vars: 2,  category: 'Grid',          feeds: 'R7 county-level cyber-exposure (secondary)' },
    ...
    { id: 'MTEF',   name: 'Department of Environment, Climate and Communications',         url: 'gov.ie/decc',                      freq: 'Annual',    res: 'Province',          vars: 2,  category: 'Economic',      feeds: 'Energy transition investment, nuclear transition metrics' },
    { id: 'CEREMA', name: 'Cerema (Centre d\'études risques)',             url: 'opw.ie',                             freq: 'Annual',    res: 'County',     vars: 1,  category: 'Environment',   feeds: 'Environmental risk indicators, flood zones' },
    { id: 'Revenue',  name: 'Revenue Commissioners Statistics',                       url: 'revenue.ie',                        freq: 'Annual',    res: 'County',     vars: 1,  category: 'Socio-Econ',    feeds: 'R3 fiscal enrichment, county revenue capacity' },
    ...
    { id: 'RPII',   name: 'RPII Nuclear Safety',                           url: 'epa.ie',                               freq: 'Annual',    res: 'County',     vars: 1,  category: 'Hazard',        feeds: 'Nuclear proximity, radiation zones' },
    { id: 'CSO-Poverty',  name: 'CSO Poverty Statistics',             url: 'cso.ie/poverty',       freq: 'Annual',    res: 'County',     vars: 2,  category: 'Socio-Econ',    feeds: 'R3 energy poverty, V_socio income vulnerability' },
    { id: 'ESBN',   name: 'ESB Networks Open Data',                              url: 'esbnetworks.ie',                        freq: 'Annual',    res: 'County',     vars: 2,  category: 'Grid',          feeds: 'Grid investment, DSO quality statistics, smart meter deployment' },
    { id: 'EirGrid-N',  name: 'EirGrid TDP (Transmission Development Plan)',                           url: 'eirgrid.ie/sddr',                   freq: 'Monthly',   res: 'TSO zone',        vars: 2,  category: 'Grid',          feeds: 'Network development plan, congestion data' },
    { id: 'SEAI',   name: 'SEAI EV Data',        url: 'seai.ie/statistics', freq: 'Quarterly', res: 'County', vars: 1,  category: 'Transition',    feeds: 'EV registration data' },
    { id: 'DREAL',  name: 'EPA (Environmental Protection Agency)',                 url: 'epa.ie/flooding',                    freq: 'Continuous',res: 'County',     vars: 1,  category: 'Hazard',        feeds: 'Flood zones, critical infrastructure alerts' },
    { id: 'BPI',    name: 'Enterprise Ireland Innovation',                          url: 'enterprise-ireland.com',                          freq: 'Quarterly', res: 'County',     vars: 1,  category: 'Economic',      feeds: 'E2 innovation enrichment' },
    { id: 'ISO-9223', name: 'ISO 9223 Corrosion',                          url: '(derived from EEA + ADEME)',            freq: 'Derived',   res: 'County',     vars: 1,  category: 'Environment',   feeds: 'I8 corrosion classification' },
    { id: 'NESC',   name: 'NESC (National Economic and Social Council)',             url: 'nesc.ie',  freq: 'Annual',    res: 'County',     vars: 2,  category: 'Socio-Econ',    feeds: 'R3 regional development gap, fiscal capacity' },
    { id: 'CRU-M',  name: 'CRU Annual Report',                         url: 'cru.ie',                                freq: 'Annual',    res: 'DSO-level',       vars: 2,  category: 'Grid',          feeds: 'CAIDI, restoration speed, quality regulation' },
    { id: 'CSO-Census',   name: 'CSO Census Geography',                    url: 'cso.ie/census',                          freq: 'Annual',    res: 'County',     vars: 1,  category: 'Socio-Econ',    feeds: 'Urban/rural classification, settlement structure' },
  ...
  const COMPONENTS = [
    {
      ...
      metrics: [
        { id: 'C1', name: 'Outage Duration', intra: 0.40, global: 0.120, norm: 'A (P5/P95)', source: 'CRU / ESB Networks', desc: 'Total annual interruption duration (SAIDI)' },
        { id: 'C2', name: 'Outage Count',    intra: 0.30, global: 0.090, norm: 'A (P5/P95)', source: 'CRU / ESB Networks', desc: 'Number of interruptions per year (SAIFI)' },
        { id: 'C3', name: 'MT Exceed Rate',  intra: 0.15, global: 0.045, norm: 'C (0–100%)', source: 'CRU', desc: 'Percentage of time voltage exceeds regulation limits' },
        { id: 'C4', name: 'Planned Outages',  intra: 0.15, global: 0.045, norm: 'B (P5/P95)', source: 'CRU-M', desc: 'Duration of planned maintenance interruptions' },
      ]
    },
    {
      ...
      metrics: [
        { id: 'V1', name: 'Severity-Weighted Dips', intra: 1.00, global: 0.100, norm: 'B (γ=0.50)', source: 'CRU Quality Report', desc: 'V = N(V1_total × (1 + 0.50 × V2_severe_ratio))' },
      ]
    },
    {
      ...
      metrics: [
        { id: 'I1', name: 'Snow/Ice Risk (IRI)',     intra: 0.12, global: 0.030, norm: 'C (0–0.30)', source: 'Open-Meteo / CRU IRI', desc: 'Climate risk index for snow and ice events', adaptive: true },
        { id: 'I2', name: 'Tree-Fall Risk (IRI)',     intra: 0.09, global: 0.023, norm: 'C (0–0.30)', source: 'Open-Meteo / CRU IRI', desc: 'Climate risk index for tree-fall events', adaptive: true },
        { id: 'I3', name: 'Heat-Wave Risk (IRI)',     intra: 0.15, global: 0.038, norm: 'C (0–0.30)', source: 'Open-Meteo / CRU IRI', desc: 'Climate risk index for heat-wave events', adaptive: true },
        { id: 'I4', name: 'RTN Density',              intra: 0.12, global: 0.030, norm: 'B ↓inverted', source: 'CRU Grid Data', desc: 'Transmission network density — higher = more resilient', inverted: true },
        ...
        { id: 'I6', name: 'Substation Density',       intra: 0.12, global: 0.030, norm: 'B ↓inverted', source: 'OSM / ESBN', desc: 'Substation density — higher = more backup capacity', inverted: true },
        { id: 'I7', name: 'Load Stress',              intra: 0.10, global: 0.025, norm: 'B (P5/P95)', source: 'EirGrid / ESB Networks', desc: 'Ratio of peak load to rated capacity', isNew: true },
        { id: 'I8', name: 'Air Quality Corrosion',    intra: 0.08, global: 0.020, norm: 'B (P5/P95)', source: 'SEAI / EEA / ISO 9223', desc: 'Air pollution corrosion risk for outdoor equipment', isNew: true },
        { id: 'I9', name: 'Hydrogeological Risk',     intra: 0.10, global: 0.025, norm: 'B (P5/P95)', source: 'GSI / EPA', desc: 'Flood and landslide territorial exposure', isNew: true },
      ]
    },
    {
      ...
      metrics: [
        { id: 'E1', name: 'CRU Penalties/User', intra: 0.55, global: 0.055, norm: 'B (P5/P95)', source: 'CRU / ESB Networks', desc: 'Per-user penalty costs from quality standard violations' },
        { id: 'E2', name: 'Productivity Loss Coefficient', intra: 0.45, global: 0.045, norm: 'C (bounded)', source: 'CSO / ESRI', desc: 'Weighted avg VoLL by local economic structure (β coefficient)' },
      ]
    },
    {
      ...
      metrics: [
        ...
        { id: 'S2', name: 'Reverse Power Flow',              intra: 0.125, global: 0.025, norm: 'D (categorical)', source: 'EirGrid / ESB', desc: '{No RPF→0, >1%→0.5, >5%→1.0}', categorical: true },
        { id: 'S3', name: 'Criticality Class',                intra: 0.125, global: 0.025, norm: 'D (categorical)', source: 'CRU', desc: '{Non-critical→0, Hospital/transport→0.5, Multiple critical→1.0}', categorical: true },
      ]
    },
    {
      ...
      isNew: true,
      metrics: [
        { id: 'T1', name: 'DER Stress Index', intra: 1.00, global: 0.050, norm: 'B (composite)', source: 'ESBN + EirGrid + SEAI', desc: 'Composite: α_DER(0.50) × N(DER_ratio) + α_VAR(0.30) × N(variability) + α_EV(0.20) × N(EV_load)', isNew: true,
          submetrics: [
            { id: 'DER_ratio', name: 'DER Penetration Ratio', weight: 0.50, source: 'ESBN Registry + EirGrid', desc: 'DER capacity / peak load by county' },
            ...
            { id: 'EV_load_ratio', name: 'EV Load Burden', weight: 0.20, source: 'SEAI + ESBN', desc: 'EV count × 7.4kW / transformer capacity' },
          ]
        },
      ]
    },
  ...
  const MODIFIERS = [
    {
      ...
      sources: ['Copernicus CDS', 'Open-Meteo / CRU IRI'],
      isEnhanced: true
    },
    {
      ...
      sources: ['CSO', 'CSO-Poverty', 'Revenue', 'NESC', 'GSI / EPA'],
      isEnhanced: true,
      enrichments: [
        { name: 'V_socio Fiscal Enrichment', effect: 'Up to +8% V_socio penalty', sources: 'Revenue + NESC + CRU' },
        { name: 'Demographic Shift Amplifier', effect: 'Up to +8% C_mult for population decline', sources: 'CSO Demographics' },
        { name: 'Elderly Vulnerability', effect: '×[1.0, 1.10] for high elderly %', sources: 'CSO Demographics' },
        { name: 'Flood Zone Amplifier', effect: 'Up to +15% C_mult for flood zones', sources: 'GSI / EPA' },
      ]
    },
    {
      id: 'R4', name: 'Graph-Theoretic Network Criticality',
      range: '[0.80, 1.35]', type: 'Multiplicative',
      desc: 'Combines degree centrality, betweenness centrality, and topological bridge detection from OSM power graph. Built from 994 substations and 4,505 grid lines.',
    ...
    },
    {
      ...
      sources: ['OSM Power Graph', 'EirGrid TDP (Transmission Development Plan)'],
      isNew: true
    },
    {
      id: 'R7', name: 'Digital Readiness Proxy',
      range: '[0.99, 1.05]', type: 'Multiplicative',
      desc: 'County-level continuous model based on DESI regional digital readiness scores, urban/rural adjustments, HV voltage class bonus, and per-substation noise. Unique values across 994 substations.',
      formula: 'R7_cyber(s) = clip( DESI_base(region) + urban_adj(county) + HV_bonus(voltage) + noise, 0.99, 1.05 )',
      sources: ['DESI / Eurostat', 'JRC DSO Observatory'],
      isNew: true,
      enrichments: [
        { name: 'County-Level DESI Computation', effect: 'Continuous [0.99, 1.05] per substation', sources: 'DESI / Eurostat' },
      ]
    },
  ];
  ...
  const DATA_LAYERS = [
    { id: 'A',   name: 'SSI v4.0.2 Resilience',        vars: 20, status: 'LIVE',        sources: 'CRU · INSEE · Dimovski · ESBN · EirGrid · SEAI · MF-OM' },
    { id: 'B.1', name: 'Grid Telemetry: Open',         vars: 3,  status: 'LIVE',        sources: 'Open-Meteo / ERA5 · CRU vintage · CRU digitalization' },
    { id: 'B.2', name: 'Grid Telemetry: Proxy',        vars: 4,  status: 'LIVE',        sources: 'IEEE C57.91 · EirGrid / ESBs · ADEME · EN 50160' },
    { id: 'B.3', name: 'Grid Telemetry: Fuzzy/Markov', vars: 12, status: 'LIVE (MARKOV)', sources: 'IEEE/CIGRÉ standards · ESBN · EEA' },
    ...
    { id: 'E',   name: 'Irish Open Data',              vars: 8,  status: 'LIVE',        sources: 'ADEME · MTEF · DGFIP · CRU · EirGrid' },
    { id: 'F',   name: 'Network Transitions',           vars: 12, status: 'LIVE (BAYESIAN)', sources: 'DSO history OR IEEE/CIGRÉ + priors' },
    { id: 'G',   name: 'Modifier Inputs',               vars: 3,  status: 'LIVE',        sources: 'CRU Monitoring · OSM Power · JRC DSO', isNew: true },
    { id: 'H',   name: 'Network & Topology',            vars: 7,  status: 'LIVE',        sources: 'EirGrid TDP (Transmission Development Plan) · GFZ · OSM · BRGM', isNew: true },
  ...
  const MASTER_EQUATION = {
    ...
    modifiers: {
      ...
      Cyber_factor: 'County_DESI_cyber(region, county, voltage) [R7]'
    },
  ...
  const VALIDATION_CHECKS = [
    { check: 'Dublin–Rural convergence gap',  criterion: 'Dublin metropolitan R systematically lower than rural West', status: 'verified' },
    { check: 'IRI-climate coherence',       criterion: 'I1 peaks in exposed Atlantic west · I3 moderate across all counties', status: 'verified' },
    ...
    { check: 'T1-DER coherence',           criterion: 'T1 peaks in Atlantic wind-belt counties', status: 'verified' },
    { check: 'R6 speed coherence',         criterion: 'R6a < 1.0 for Dublin, R6a > 1.0 for rural western counties', status: 'verified' },
    { check: 'Energy poverty gradient',    criterion: 'V_socio correlates with urban-rural divide', status: 'verified' },
    { check: 'R4 bridge identification',   criterion: 'is_bridge=1 subs have higher R than degree-matched non-bridges', status: 'verified' },
    { check: 'Climate trajectory direction', criterion: 'I3 trajectory stable, I1 moderate across Atlantic exposure', status: 'verified' },
    ...
    { check: 'Corrosion class gradient',   criterion: 'Coastal counties (Atlantic coast) C3–C5 > inland C1–C2', status: 'verified' },
  ];
  ...
  const FREQ_DISTRIBUTION = {
    ...
    Monthly: { count: 3, sources: ['ESBN Registry', 'EirGrid éCO2mix', 'EirGrid SDDR'] },
    Quarterly: { count: 2, sources: ['SEAI', 'Enterprise Ireland'] },
    Annual: { count: 20, sources: ['CRU', 'CSO', 'CSO-Poverty', 'ESBN', 'MTEF', 'SEAI', 'Revenue', 'EEA', 'Eurostat', 'DESI', 'NESC', 'CRU-M', 'CSO-Census', 'ESRI', 'SEAI-R', 'RPII', 'Open-Meteo', 'JRC', 'DREAL', 'OPW'] },
