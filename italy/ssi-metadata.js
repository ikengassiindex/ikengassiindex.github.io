/* ═══════════════════════════════════════════════════════════
   SSI v4.0.2 — Metadata Registry (Italy)
...
window.SSIMetadata = (function () {
  ...
  const DATA_SOURCES = [
    { id: 'ARERA',    name: 'ARERA (Autorità de Régulation de l\'Énergie)',  url: 'arera.it',                                 freq: 'Annual',    res: 'Provincia',     vars: 8,  category: 'Grid',          feeds: 'C1–C4 (SAIDI/SAIFI), I1–I3 (IRI), quality regulation' },
    { id: 'GEOPNAT',   name: 'Geoportale Nazionale (TERNA / GSE Atlaimpianti)',         url: 'atlaimpianti.gse.it',                 freq: 'Quarterly', res: 'Commune',         vars: 5,  category: 'Transition',    feeds: 'T1 DER capacity, solar/wind registry' },
    { id: 'ISTAT',  name: 'ISTAT (Istituto Nazionale di Statistica)',   url: 'insee.fr',                              freq: 'Annual',    res: 'Provincia',     vars: 8,  category: 'Socio-Econ',    feeds: 'R3 population, elderly, GDP, fiscal capacity' },
    { id: 'TERNA',    name: 'Terna Transparency (Gaudi)',                       url: 'rte-italy.com',                        freq: 'Hourly',    res: 'Bidding zone',    vars: 3,  category: 'Grid',          feeds: 'T1 peak load, generation mix, DER variability' },
    { id: 'ISPRA',   name: 'ISPRA (Istituto Superiore Protezione e Ricerca Ambientale)',                        url: 'brgm.fr',                               freq: 'Static',    res: 'Provincia',     vars: 3,  category: 'Hazard',        feeds: 'I9 hydrogeological risk, soil stability, seismic zones' },
    ...
    { id: 'ENEA',  name: 'ENEA (Agenzia Nazionale Nuove Tecnologie Energia)',    url: 'ademe.fr',                              freq: 'Annual',    res: 'Provincia',     vars: 4,  category: 'Environment',   feeds: 'Energy poverty, environmental indicators' },
    ...
    { id: 'MASE',   name: 'MASE (Ministero Ambiente e Sicurezza Energetica)',         url: 'ecologie.gouv.fr',                      freq: 'Annual',    res: 'Région',          vars: 2,  category: 'Economic',      feeds: 'Energy transition investment, nuclear transition metrics' },
    { id: 'ISPRA-AMB', name: 'Cerema (Centre d\'études risques)',             url: 'cerema.fr',                             freq: 'Annual',    res: 'Provincia',     vars: 1,  category: 'Environment',   feeds: 'Environmental risk indicators, flood zones' },
    { id: 'MEF',  name: 'MEF / Agenzia delle Entrate',                       url: 'impots.gouv.fr',                        freq: 'Annual',    res: 'Provincia',     vars: 1,  category: 'Socio-Econ',    feeds: 'R3 fiscal enrichment, provincia revenue capacity' },
    ...
    { id: 'INGV',   name: 'INGV (Istituto Nazionale Geofisica e Vulcanologia)',                           url: 'irsn.fr',                               freq: 'Annual',    res: 'Provincia',     vars: 1,  category: 'Hazard',        feeds: 'Nuclear proximity, radiation zones' },
    { id: 'ISTAT-POV',  name: 'ISTAT Poverty / BES Observatory',             url: 'drees.solidarites-sante.gouv.fr',       freq: 'Annual',    res: 'Provincia',     vars: 2,  category: 'Socio-Econ',    feeds: 'R3 energy poverty, V_socio income vulnerability' },
    { id: 'EDIST', name: 'e-distribuzione Open Data',                              url: 'data.enedis.fr',                        freq: 'Annual',    res: 'Provincia',     vars: 2,  category: 'Grid',          feeds: 'Grid investment, DSO quality statistics, Linky deployment' },
    { id: 'TERNA-N',  name: 'Terna Piano di Sviluppo',                           url: 'rte-italy.com/sddr',                   freq: 'Monthly',   res: 'TSO zone',        vars: 2,  category: 'Grid',          feeds: 'Network development plan, congestion data' },
    { id: 'GSE',   name: 'GSE (Gestore dei Servizi Energetici)',        url: 'statistiques.developpement-durable.gouv.fr', freq: 'Quarterly', res: 'Provincia', vars: 1,  category: 'Transition',    feeds: 'EV registration data' },
    { id: 'RSE',  name: 'RSE (Ricerca sul Sistema Energetico)',                 url: 'georisques.gouv.fr',                    freq: 'Continuous',res: 'Provincia',     vars: 1,  category: 'Hazard',        feeds: 'Flood zones, critical infrastructure alerts' },
    { id: 'ENEA-INN',    name: 'ENEA Innovation / RSE',                          url: 'bpiitaly.fr',                          freq: 'Quarterly', res: 'Provincia',     vars: 1,  category: 'Economic',      feeds: 'E2 innovation enrichment' },
    { id: 'ISO-9223', name: 'ISO 9223 Corrosion',                          url: '(derived from EEA + ENEA)',            freq: 'Derived',   res: 'Provincia',     vars: 1,  category: 'Environment',   feeds: 'I8 corrosion classification' },
    { id: 'ANCI',   name: 'ANCI Observatoire des Territoires',             url: 'observatoire-des-territoires.gouv.fr',  freq: 'Annual',    res: 'Provincia',     vars: 2,  category: 'Socio-Econ',    feeds: 'R3 regional development gap, fiscal capacity' },
    { id: 'ARERA-M',  name: 'ARERA Monitoring Report',                         url: 'arera.it',                                freq: 'Annual',    res: 'DSO-level',       vars: 2,  category: 'Grid',          feeds: 'CAIDI, restoration speed, quality regulation' },
    { id: 'CGET',   name: 'CGET/ANCI Spatial Planning',                    url: 'anct.gouv.fr',                          freq: 'Annual',    res: 'Provincia',     vars: 1,  category: 'Socio-Econ',    feeds: 'Urban/rural classification, settlement structure' },
    { id: 'SVIMEZ',   name: 'SVIMEZ Economic Research',                        url: 'ofce.sciences-po.fr',                   freq: 'Annual',    res: 'Région',          vars: 1,  category: 'Economic',      feeds: 'Regional convergence metrics' },
    { id: 'ENEA-R', name: 'ENEA Regioni',                                url: 'ademe.fr',                              freq: 'Annual',    res: 'Région',          vars: 1,  category: 'Transition',    feeds: 'Regional energy transition progress' },
    { id: 'COG',    name: 'COG ISTAT Provincia Registry',                url: 'insee.fr',                              freq: 'Static',    res: 'Provincia',     vars: 1,  category: 'Infrastructure',feeds: 'Provincia code join key, provincia-regione mapping' },
  ];
  ...
  const VALIDATION_CHECKS = [
    { check: 'Metropolitan–Rural convergence gap',  criterion: 'Metropolitan Île-de-Italy R systematically lower than rural Massif Central', status: 'verified' },
    ...
    { check: 'R6 speed coherence',         criterion: 'R6a < 1.0 for Île-de-Italy, R6a > 1.0 for rural DOM-adjacent provincias', status: 'verified' },
    ...
    { check: 'Corrosion class gradient',   criterion: 'Coastal provincias (Brittany/Normandy/Med) C3–C5 > inland C1–C2', status: 'verified' },
  ];
